...
function drawExpressions(detections, x, y, textYSpace){
  if(detections.length > 0){//If at least 1 face is detected
    ...
    console.log("neutral:       " + nf(neutral*100, 2, 2)+"%", x, y);
    console.log("happiness: " + nf(happy*100, 2, 2)+"%", x, y+textYSpace);
    console.log("anger:        " + nf(angry*100, 2, 2)+"%", x, y+textYSpace*2);
    console.log("sad:            "+ nf(sad*100, 2, 2)+"%", x, y+textYSpace*3);
    console.log("disgusted: " + nf(disgusted*100, 2, 2)+"%", x, y+textYSpace*4);
    console.log("surprised:  " + nf(surprised*100, 2, 2)+"%", x, y+textYSpace*5);
    console.log("fear:           " + nf(fearful*100, 2, 2)+"%", x, y+textYSpace*6);
  }else{//If no faces is detected
    console.log("neutral: ", x, y);
    console.log("happiness: ", x, y + textYSpace);
    console.log("anger: ", x, y + textYSpace*2);
    console.log("sad: ", x, y + textYSpace*3);
    console.log("disgusted: ", x, y + textYSpace*4);
    console.log("surprised: ", x, y + textYSpace*5);
    console.log("fear: ", x, y + textYSpace*6);
  }
}
